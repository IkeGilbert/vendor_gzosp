...
# Versioning System
# H4K3ROM first version.
PRODUCT_VERSION_MAJOR = PIE.9
...
ifndef GZOSP_BUILD_TYPE
    GZOSP_BUILD_TYPE := OFFICIAL
endif

# Set all versions
GZOSP_VERSION := H4K3ROM-$(GZOSP_BUILD)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(GZOSP_BUILD_TYPE)$(GZOSP_POSTFIX)
